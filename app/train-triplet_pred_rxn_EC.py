...
def main():
    ...
    model_lookup_train = pickle.load(open('./data/inputs/pred_rxn_EC12/model_lookup_train.pkl', 'rb'))
    ...
    best_loss = float('inf')
    train_loader = get_dataloader( esm_emb, model_lookup_train, labels, args)
